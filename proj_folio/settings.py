"""
Django settings for proj_folio project.
...
TEMPLATES = [
    {
        ...
        #   os.path.join(BASE_DIR, 'folio_back/templates/folio_back'), # old_portfolio app
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'proj_folio.wsgi.application'
